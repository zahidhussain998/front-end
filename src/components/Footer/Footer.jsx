    ...
    <div className="">
      ...
      <nav aria-label="Footer Navigation" className="text-gray-500">
        <ul className="space-y-3">
          <li><a className="hover:text-black hover:underline" href="#">Pricing</a></li>
          <li><a className="hover:text-black hover:underline" href="#">Demo</a></li>
          <li><a className="hover:text-black hover:underline" href="#">Press</a></li>
          <li><a className="hover:text-black hover:underline" href="#">Support Hub</a></li>
    ...
    <div className="">
      ...
      <div className="flex flex-col">
        <div className="mb-4">
          ...
          <button className="block rounded-xl bg-black px-6 py-3 font-medium text-white">Subscribe</button>
        </div>
      </div>
    </div>
  </div>
